...
Então, em vez disso, que tal ir dar uma olhada nas [Boas Práticas :train:](https://github.com/danlongname/rubi-sobre-trilhos/blob/main/linhas/boas-praticas/README.md)?
